...
class Loading_Model():
    def __init__(self):
        ...
        model_task = "multitask-qa-qg"
        model_name = "valhalla/t5-base-qa-qg-hl"
        self.T5 = pipelines_pipeline(model_task, model_name)
    
    def get_response_BERT_T5(self, q):
        ...
        top_para = "question: " + q + " context: " + question_answer_dict_list_sorted[0]['answer'] + ' ' + question_answer_dict_list_sorted[0]['answer'] + ' ' + question_answer_dict_list_sorted[0]['context']
